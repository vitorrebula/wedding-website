    ...
    <section id="tickets" className="section-padding bg-secondary/50 py-24">
      <div className="container mx-auto max-w-5xl px-6">
        <motion.div {...fadeUp} className="text-center mb-16">
          ...
          <h2 className="mt-2 font-display text-4xl md:text-5xl font-semibold text-foreground tracking-tight uppercase">Ingressos</h2>
          <div className="mt-6 w-16 h-px bg-gold mx-auto" />
          <p className="mt-6 font-body text-muted-foreground max-w-lg mx-auto">
            Os ingressos da balada são vendidos antecipadamente.
          </p>
        </motion.div>
